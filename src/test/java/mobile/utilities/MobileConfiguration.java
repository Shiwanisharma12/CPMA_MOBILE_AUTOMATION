...
//            desiredCapabilities.setCapability("username", config.getConfig(mobilePlatform).withFallback(config).getConfig(mobilePlatform).getConfig(deviceName).getString("username"));
//            desiredCapabilities.setCapability("password", config.getConfig(mobilePlatform).withFallback(config).getConfig(mobilePlatform).getConfig(deviceName).getString("password"));
